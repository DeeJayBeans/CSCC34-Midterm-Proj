...
@#$#@#$#@
<experiments>
  <experiment name="WSP-Experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="weed-energy">
      <value value="0"/>
      <value value="1"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="weeds-grow-rate">
      <value value="1"/>
      <value value="2"/>
      <value value="3"/>
    </enumeratedValueSet>
